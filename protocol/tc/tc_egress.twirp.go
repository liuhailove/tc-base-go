...
func NewEgressProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Egress {
	...
	serviceURL += baseServicePath(pathPrefix, "tc", "Egress")
	urls := [9]string{
...
const EgressPathPrefix = "/twirp/tc.Egress/"
...
func (s *egressServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "tc", "Egress")
}
