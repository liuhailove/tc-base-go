...
func NewIngressProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Ingress {
	...
	serviceURL += baseServicePath(pathPrefix, "tc", "Ingress")
	urls := [4]string{
...
const IngressPathPrefix = "/twirp/tc.Ingress/"
...
func (s *ingressServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "tc", "Ingress")
}
