...
func NewRoomServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) RoomService {
	...
	serviceURL += baseServicePath(pathPrefix, "tc", "RoomService")
	urls := [11]string{
...
const RoomServicePathPrefix = "/twirp/tc.RoomService/"
...
func (s *roomServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "tc", "RoomService")
}
